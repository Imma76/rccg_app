...
RccgMovieSearchModel rccgMovieSearchModelFromJson(String str) => RccgMovieSearchModel.fromJson(json.decode(str));

String rccgMovieSearchModelToJson(RccgMovieSearchModel data) => json.encode(data.toJson());

class RccgMovieSearchModel {
  RccgMovieSearchModel({
    this.kind,
    this.etag,
    this.nextPageToken,
    this.regionCode,
  ...
  factory RccgMovieSearchModel.fromJson(Map<String, dynamic> json) => RccgMovieSearchModel(
    kind: json["kind"],
    etag: json["etag"],
