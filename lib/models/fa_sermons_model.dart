...
//
//     final faSermonsModel = faSermonsModelFromJson(jsonString);

import 'dart:convert';

FaSermonsModel faSermonsModelFromJson(String str) => FaSermonsModel.fromJson(json.decode(str));

String faSermonsModelToJson(FaSermonsModel data) => json.encode(data.toJson());

class FaSermonsModel {
  FaSermonsModel({
    this.kind,
    this.etag,
    this.nextPageToken,
  ...
  String? regionCode;
  PageInfo? pageInfo;
  List<FaVideoItem>? videoDetails;

  factory FaSermonsModel.fromJson(Map<String, dynamic> json) => FaSermonsModel(
    kind: json["kind"],
    etag: json["etag"],
    nextPageToken: json["nextPageToken"],
    regionCode: json["regionCode"],
    pageInfo: json["pageInfo"] == null ? null : PageInfo.fromJson(json["pageInfo"]),
    videoDetails: json["items"] == null ? [] : List<FaVideoItem>.from(json["items"]!.map((x) => FaVideoItem.fromJson(x))),
  );
...
class FaVideoItem {
  ...
  factory FaVideoItem.fromJson(Map<String, dynamic> json) => FaVideoItem(
    kind: json["kind"],
    etag: json["etag"],
