...
//
//     final mountZionMovies = mountZionMoviesFromJson(jsonString);

import 'dart:convert';

MountZionMovies mountZionMoviesFromJson(String str) => MountZionMovies.fromJson(json.decode(str));

String mountZionMoviesToJson(MountZionMovies data) => json.encode(data.toJson());

class MountZionMovies {
  MountZionMovies({
    this.kind,
    this.etag,
    this.nextPageToken,
...
class MountZionVideoItem {
  ...
  factory MountZionVideoItem.fromJson(Map<String, dynamic> json) => MountZionVideoItem(
    kind: json["kind"],
    etag: json["etag"],
