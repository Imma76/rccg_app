...
//
//     final feastofEsther = feastofEstherFromJson(jsonString);

import 'dart:convert';

FeastofEsther feastofEstherFromJson(String str) => FeastofEsther.fromJson(json.decode(str));

String feastofEstherToJson(FeastofEsther data) => json.encode(data.toJson());
...
class FeastofEsther {
  ...
  List<FeastOfEstherVideoItem>? items;
  PageInfo? pageInfo;

  factory FeastofEsther.fromJson(Map<String, dynamic> json) => FeastofEsther(
    kind: json["kind"],
    etag: json["etag"],
    nextPageToken: json["nextPageToken"],
    items: json["items"] == null ? [] : List<FeastOfEstherVideoItem>.from(json["items"]!.map((x) => FeastOfEstherVideoItem.fromJson(x))),
...
class FeastOfEstherVideoItem {
  FeastOfEstherVideoItem({
    this.kind,
    this.etag,
    this.id,
    this.snippet,
