          ...
          children: [
                    ...
                    child:  Center(
                      child: Row(
                        children: [
                          ...
                          const Icon(Icons.arrow_forward_ios_rounded,color: LightAppTheme.white ,size: 12,)
                        ],
                      ),
                    ),
                    // Column(
            ...
            Padding(
              ...
              child: Container(
                // width:329.w,
                height: 120.h,
                padding: EdgeInsets.only(top: 12.h, left: 0),
                decoration: BoxDecoration(
                    color: LightAppTheme.white,
                    boxShadow: const [
                      BoxShadow(
                ...
                child: Row(
                  children: [
                    Container(color: LightAppTheme.purple,width: 3,),
                    ...
                    Column(
                      ...
                      children: [
                        SizedBox(
                            width: 250.w,
                            child: Text('Jesus Christ the same yesterday, and to day, and for ever.',
                                style: GoogleFonts.inter(
                                    fontWeight: FontWeight.w600,
                                    fontSize: 14.sp,
                ...
                children: [
                  Expanded(
                    child: GestureDetector(
                      ...
                      child: const FeatureCard(name: 'Rccg Manual', image:  'assets/manuals.png',color:LightAppTheme.lightPurple3 ,imageColor:LightAppTheme.purple ,),
                    ),
                  ),
                  Gap(14.w),
                  Expanded(
                    child: GestureDetector(
                      onTap: () {
                        Navigator.pushNamed(
                            context, RccgCharlets.route);
                      },
                      child: const FeatureCard(name: 'Rccg Charlets', image:    'assets/charlets.png',color:LightAppTheme.lightGreen,imageColor:LightAppTheme.lightBlue2 ,),
                  ...
                  Expanded(
                    child: GestureDetector(
                      onTap: () async {
                        ...
                        //     Authentication.route, (route) => false);
                        Navigator.pushNamed(
                            context, RccgProgram.route);
                      },
                      child: const FeatureCard(name: 'Rccg Programs', image:  'assets/app_logo.png',color:LightAppTheme.lightGreen2 ,),
                    ),
                  ),
                  Gap(14.w),
                  Expanded(
                    child: GestureDetector(
                      onTap: () {
                        Navigator.pushNamed(
                            context, RccgEvents.route);
                      },
                      child: const FeatureCard(name: 'Rccg Events', image:    'assets/events_icon.png',color:LightAppTheme.lightOrange,imageColor:LightAppTheme.darkOrange,),
                  ...
                  Expanded(
                    child: GestureDetector(
                      onTap: () async {
                        ...
                        //     Authentication.route, (route) => false);
                        Navigator.pushNamed(
                            context, RccgHymns.route);
                      },
                      child: const FeatureCard(name: 'Rccg Hymns', image:  'assets/music.png',color:LightAppTheme.lightBrown ,imageColor:LightAppTheme.darkBrown,),
                    ),
                  ),
                  Gap(14.w),
                  Expanded(
...
//                         ));
                      ...
                      child: const FeatureCard(name: 'Kids, Adults Christian Movies', image:    'assets/play2.png',color:LightAppTheme.lightPurple3,imageColor:LightAppTheme.lightBlue2 ,),
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Center(
                              child: Text('Let us know how you feel today?',
                                  style: GoogleFonts.inter(
                                      fontWeight: FontWeight.w500,
                                      fontSize: 14.sp,
                                      color: LightAppTheme.black)),
            ...
            //     child: SizedBox(
            //       height: 220.h,
            //       child:programController.loadMovies?const Indicator():  ListView.builder(
            //           itemCount: programController.christianMovieModel!.videoDetails!.length,
            //           scrollDirection: Axis.horizontal,
            //           shrinkWrap: true,
            //           itemBuilder: (context,index) {
...
class FeatureCard extends StatelessWidget {
  ...
  const FeatureCard({
    super.key,this.name, this.image, this.color,this.imageColor
  });
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      width: 158.w,
      decoration: BoxDecoration(
          color: color??LightAppTheme.white,
          borderRadius: BorderRadius.circular(10)),
      child: Center(
        child: Column(
          crossAxisAlignment:
